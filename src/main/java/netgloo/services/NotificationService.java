...
public class NotificationService {
  ...
  /**
   *
   * Send notification to all subscribed user on channel "/queue/notify".
   *
   * @param notification
   */
  public void notifyToAll(Notification notification) {
    messagingTemplate.convertAndSend ( "/queue/notify/all", notification );
