...
public class MainController {
   ...
   *
   * 로그인 세션 유저가 UserA인 브라우저에게만 Push
   * 
   ...
   * @return
   */
  @RequestMapping(value = "/some-action-all", method = RequestMethod.POST)
  @ResponseBody
  public ResponseEntity<?> someActionAll() {

    // Do an action here
    // ...
    notificationService.notifyToAll ( new Notification ( "Hello, All!" ) );
